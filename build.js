  ...
  try {
    ...
    const staticGrid = PRODUCTS_ALL.slice().sort((a, b) => (a.order || 99) - (b.order || 99)).map(p => `
      <article class="sp-card">
        ...
        <p class="sp-meta"><span class="sb-price" data-handle="${esc(p.id)}" data-aed="${esc(String(p.price))}">AED ${esc(String(p.price))}</span> &middot; ${esc(p.garment === 'polo' ? '240 GSM piqué' : '230 GSM cotton')} &middot; unisex S&ndash;XL</p>
...
const COMMERCE = [
  {
    ...
    faqs: [
      ['Where do you ship?', 'We ship worldwide from Dubai. In the UAE: same-day in Dubai when you order by 2pm, next-day everywhere else, free over AED 150. GCC (Saudi Arabia, Qatar, Oman, Bahrain, Kuwait): 3–5 working days, AED 50, free over AED 400. Everywhere else: 7–14 working days, AED 80. Any import duties on international orders are payable on arrival. Exact cost always appears at checkout before you pay.'],
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Practical things', body: "All our t-shirts are AED 199 and come in Regular and Oversized fits. The Sahra Polo is AED 229 and comes in one fit. Everything is cut unisex, S to XL. In the UAE, delivery is same-day in Dubai (order by 2pm) or next-day everywhere else, free over AED 150 — and we now ship worldwide too. Exact delivery cost is always shown at checkout before you pay.\n\nIf you are unsure about size, exchanges within the UAE are free within 14 days of delivery, as long as the piece is unworn with tags attached. If you are buying as a gift and want to be certain, email us and we will help you choose." }
    ],
    faqs: [
      ...
      ['Do you ship outside the UAE?', 'Yes — worldwide, from Dubai. GCC orders (Saudi Arabia, Qatar, Oman, Bahrain, Kuwait) arrive in 3–5 working days at AED 50, free over AED 400. The rest of the world is 7–14 working days at AED 80. Any import duties are payable on arrival.']
    ]
  },
  {
  ...
  },
  {
    ...
    sizeTable: true,
    sections: [
      { h2: 'Regular or oversized?', body: "Regular is a classic straight cut. It sits close to the body without being tight, and layers cleanly under a shacket or jacket. This cut runs slim: if you normally wear a medium on the high street and like that fit, take a large here. Stay with your usual letter only if you want it noticeably closer to the body.\n\nOversized is a deliberately wider cut with a dropped shoulder and more room through the body. It is designed to be worn on its own rather than layered. If you are between sizes and want the relaxed look, size down rather than up — the oversized cut already adds width." },
